...
include('includes/commentparse.php');
?>

<main class="content">

<?php //get the one published post
$query = 		"SELECT posts.title, posts.body, posts.image, posts.date, posts.post_id, users.username, users.user_id, categories.name, posts.allow_comments
...
<?php
if($allow_comments){
include('includes/commentsform.php');
}?>
